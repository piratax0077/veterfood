    ...
    <form method="POST" action="{{ route('registro.cliente') }}">
        ...
        <div class="cuenta-campos">
            ...
            <div class="cuenta-clave">
                ...
                <input class="form-control form-control-sm" type="password" id="registro-clave" name="password" autocomplete="new-password" required>
            ...
            <div class="cuenta-clave">
                ...
                <input class="form-control form-control-sm" type="password" id="registro-clave-repetir" name="password_confirmation" autocomplete="new-password" required>
