...
@php $pesos = fn ($monto) => '$' . number_format($monto, 0, ',', '.'); @endphp
<div @class(['card', 'producto-card', 'is-oferta' => $producto->en_oferta])>
    ...
    <span class="badge">{{ $producto->categoria_etiqueta }}</span>
    ...
    <div class="producto-precios">
        ...
        <span class="muted producto-stock">Stock {{ $producto->stock }}</span>
    </div>
