...
@section('content')
<style>
    .voucher-user-hero{display:flex;justify-content:space-between;gap:18px;align-items:center;background:linear-gradient(120deg,#be185d,#ec4899);color:#fff;border-radius:16px;padding:24px;margin-bottom:20px;box-shadow:0 12px 30px rgba(190,24,93,.2)}
    .voucher-user-hero h1{margin:0 0 7px}.voucher-user-hero p{margin:0}.voucher-count{font-size:30px;font-weight:900;background:rgba(255,255,255,.18);border-radius:14px;padding:12px 18px;text-align:center}
    .voucher-user-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(520px,1fr));gap:16px}.voucher-user-card{background:#fff;border:2px solid #fbcfe8;border-radius:14px;padding:18px;box-shadow:0 8px 20px rgba(15,23,42,.07);display:grid;grid-template-columns:minmax(0,1fr) 160px;gap:20px;align-items:center}.voucher-user-info{display:grid;gap:12px;min-width:0}.voucher-user-qr{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;padding:12px;border:1px solid #fbcfe8;border-radius:12px;background:#fff7fb}.voucher-user-qr img{display:block;width:140px;height:140px;object-fit:contain;background:#fff}.voucher-user-qr span{color:#9d174d;font-size:12px;font-weight:800;text-align:center}
    .voucher-value{font-size:30px;font-weight:900;color:#be185d}.voucher-code{font-family:Consolas,monospace;background:#111827;color:#fff;border-radius:8px;padding:9px 11px;font-weight:800;letter-spacing:.05em}.voucher-meta{display:grid;gap:6px;color:#475569;font-size:14px}.voucher-origin{display:inline-block;background:#fce7f3;color:#9d174d;border-radius:999px;padding:5px 9px;font-size:12px;font-weight:800;width:max-content}
