            ...
            <div class="form-section">
                ...
                <form method="POST" action="<?php echo e(route('registro.cliente')); ?>">
                    ...
                    <div class="form-grid">
                        ...
                        <div><label class="floating-label-activo-sm">Celular</label><input class="form-control form-control-sm" name="telefono" value="<?php echo e(old('telefono', '+56')); ?>"></div>
                        ...
                        <div class="span-2"><label class="floating-label-activo-sm">Dirección principal</label><input class="form-control form-control-sm" name="direccion" value="<?php echo e(old('direccion')); ?>"></div>
    ...
    <footer class="site-footer">
        <div class="footer-inner">
            <div class="footer-brand">
                <img class="footer-logo" src="<?php echo e(asset('images/logotipo/logo-veterfood-blanco.svg')); ?>" alt="Comercializadora Alimentos">
