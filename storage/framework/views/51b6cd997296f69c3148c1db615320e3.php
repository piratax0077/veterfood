...
<style>
    ...
    .hero-wrap{position:relative;background-image:linear-gradient(90deg,rgba(238,244,248,.84) 0%,rgba(238,244,248,.5) 48%,rgba(238,244,248,.08) 100%),url('<?php echo e(asset('images/inicio-alimentos-hero.png')); ?>');background-size:cover;background-position:center;overflow:hidden}
    ...
    <div class="hero">
        <div class="hero-copy">
            ...
            <div class="hero-actions">
                ...
                <a class="btn btn-success" href="<?php echo e(route('tienda.catalogo')); ?>">Ver tienda</a>
            </div>
            ...
            <div class="form-section">
                ...
                <form method="POST" action="<?php echo e(route('registro.cliente')); ?>">
                    ...
                    <div class="form-grid">
                        ...
                        <div><label class="floating-label-activo-sm">Telefono</label><input class="form-control form-control-sm" name="telefono" value="<?php echo e(old('telefono')); ?>"></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\alimentos-laravel13\resources\views/inicio.blade.php ENDPATH**/ ?>