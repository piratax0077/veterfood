...
?>
    ...
    <link rel="stylesheet" href="<?php echo e($assetVersionado('css/notificaciones.css')); ?>">
    <link rel="stylesheet" href="<?php echo e($assetVersionado('css/menu-lateral.css')); ?>">
    <link rel="stylesheet" href="<?php echo e($assetVersionado('css/cargando-tienda.css')); ?>">
    <link rel="stylesheet" href="<?php echo e($assetVersionado('css/encabezado-pagina.css')); ?>">
...
<?php endif; ?>
<?php $component->withAttributes(['nombre' => 'tienda']); ?>
...
<?php endif; ?>Ir a tienda
                        <?php if($carroTotal > 0): ?>
                            <span class="carro-contador" aria-hidden="true"><?php echo e($carroTotal); ?></span>
                        <?php endif; ?>
                    </a>
                <?php endif; ?>
                ...
                <?php endif; ?>
                <?php if(auth()->user()->tieneRol('admin') && !request()->routeIs('admin.dashboard')): ?>
                    <a class="nav-accion" href="<?php echo e(route('admin.dashboard')); ?>"><?php if (isset($component)) { $__componentOriginal1cc77f99ef34ed73061e695fbeb001f6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1cc77f99ef34ed73061e695fbeb001f6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icono','data' => ['nombre' => 'inicio']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icono'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['nombre' => 'inicio']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal1cc77f99ef34ed73061e695fbeb001f6)): ?>
<?php $attributes = $__attributesOriginal1cc77f99ef34ed73061e695fbeb001f6; ?>
...
<?php endif; ?>Volver al inicio</a>
                ...
                <?php endif; ?>
                <?php if (! (auth()->user()->tieneRol('cliente','dueno_mascota') && request()->routeIs('cliente.*', 'encuesta.usuario', 'vouchers.usuario'))): ?>
                    <form method="POST" action="<?php echo e(route('logout')); ?>"><?php echo csrf_field(); ?><button class="link-button nav-accion nav-accion--salir" type="submit"><?php if (isset($component)) { $__componentOriginal1cc77f99ef34ed73061e695fbeb001f6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1cc77f99ef34ed73061e695fbeb001f6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icono','data' => ['nombre' => 'salir']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icono'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['nombre' => 'salir']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal1cc77f99ef34ed73061e695fbeb001f6)): ?>
<?php $attributes = $__attributesOriginal1cc77f99ef34ed73061e695fbeb001f6; ?>
...
<?php $component = $__componentOriginal1cc77f99ef34ed73061e695fbeb001f6; ?>
<?php unset($__componentOriginal1cc77f99ef34ed73061e695fbeb001f6); ?>
<?php endif; ?>Cerrar sesión</button></form>
                <?php endif; ?>
            <?php else: ?>
